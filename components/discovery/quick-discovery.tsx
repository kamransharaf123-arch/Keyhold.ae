    ...
    <section className="border-b border-black/[0.07] bg-[var(--color-champagne-soft)]">
      <form action="/discover" method="get" className="site-container grid gap-3 py-5 md:grid-cols-[minmax(0,1.5fr)_minmax(9rem,0.7fr)_minmax(11rem,0.8fr)_auto] md:items-end">
        <label>
          ...
          <input name="q" type="search" placeholder="Project, area, developer or lifestyle" className="min-h-12 w-full border border-black/10 bg-[var(--color-soft-white)] px-4 text-base outline-none focus:border-[var(--color-teal)]" />
        </label>
        <label>
